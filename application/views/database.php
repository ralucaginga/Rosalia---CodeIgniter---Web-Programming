    ...
    <div class="site-section" align="center">
      <div class="container">
          ...
          <table style="text-align:center;border:1px solid black;">
              ...
              <th colspan="3" style="border:1px solid black;"><strong>Actions</strong></th>
              </tr>
              <?php foreach($this->f->getImages() as $var){?>
              <tr style="border:1px solid black;">
                  <td style="border:1px solid black;"><?php echo $var->Nume;?></td>
                  <td style="border:1px solid black;"><img src="<?php echo base_url($var->Imagine);?>" width="200" height="200"></td>
                  <td style="border:1px solid black;"><?php echo $var->Culoare;?></td>
                  <td style="border:1px solid black;"><?php echo $var->Marime;?></td>
                  <td style="border:1px solid black;"><?php echo $var->Pret;?></td>
                  <td><?php echo anchor(array('Rosalia/view',$var->ID),'View');?></td>
                  <td><?php echo anchor(array('Rosalia/edit',$var->ID),'Edit');?></td>
                  <td><?php echo anchor(array('Rosalia/delete',$var->ID),'Delete',array('onclick'=>'return confirm("Do you want to delete this record?")'));?></td>
              </tr>
              <?php }?>
          </table>
          <?php echo anchor(array('Rosalia/upload/'),'Insert and Upload');?>
