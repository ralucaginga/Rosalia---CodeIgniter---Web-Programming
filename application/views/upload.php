  ...
  <div class="site-wrap">
    ...
    <div class="site-section" align="center">
      <div class="container" style="text-align:center;">
          ...
          <?php echo form_open_multipart('Rosalia/save');?>
          <table class="table">
              <tr>
                  <td>Nume</td>
                  <td><?php echo form_input('Nume');?></td>
              </tr>
              <tr>
                  <td>Imagine</td>
              ...
              <tr>
                  <td>Culoare</td>
                  <td><?php echo form_input('Culoare');?></td>
              </tr>
              <tr>
                  <td>Marime</td>
                  <td><?php echo form_input('Marime');?></td>
              </tr>
              <tr>
                  <td>Pret</td>
              ...
              <tr>
                  <td></td>
                  <td><?php echo form_submit('submit','Insert','class="btn btn-primary"');?></td>
              </tr>
              </table>
      </div>
     </div>
